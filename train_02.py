"""
Main difference from train_01.py to train_02.py is the .item() call.

Now we only run cudaDeviceSyncronize on the last call.

But this is weird because it actually increases Wall-clock time.

Looking at the trace we actually see Command Buffer Full. Which is what
I think makes this second version slower.
"""
